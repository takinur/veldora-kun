        ...
        <tbody class="bg-white">
            ...
            <tr class="text-gray-700">
                <td class="px-4 py-3 border">
                    <div class="flex items-center text-sm">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600 capitalize">@foreach ($user->roles as $role )
                                {{ $role->name }}
                                @endforeach</p>
                        </div>
                    </div>
                </td>
                <td class="px-2 py-1 text-ms border">{{ $user->email }}</td>
                <td class="px-4 py-3 text-sm border">{{ $user->phone }}</td>
                ...
                <td class="px-4 py-3 text-xs border">
                    ...
                    <span
                        class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm capitalize">
                        Aprroved
                    </span>
                    @else
                    <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-sm capitalize">
                        Pending
                    </span>
                    @endif
                </td>
                <td class="py-3 px-4 text-center text-xs border">
                    <div class="flex item-center justify-center">
                        ...
                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                            <a href="#" class="modal-open" wire:click='deleteUser({{ $user->id }})'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <tr class="text-gray-700">
                <td class="px-4 py-3 border">
                    <div class="flex items-center text-sm">
                        <div>
                            <p class="font-semibold text-black">No</p>
                            <p class="text-xs text-gray-600">User-Found</p>
                        </div>
                    </div>
                </td>
        ...
        <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-bold">Deleting USER!</p>
                ...
                <div class="">
                    ...
                    <div class="text-center p-5 flex-auto justify-center">
                        ...
                        <h2 class="text-xl font-bold py-4 ">Are you sure?</h3>
                            <p class="text-sm text-gray-500 px-8">Do you really want to delete users account?
