                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-600">Todays Bookings</h5>
                                <h3 class="font-bold text-3xl">
                                    {{ !empty($data['newBooking']) ? $data['newBooking'] : '0'}}
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-600">All Bookings</h5>
                                <h3 class="font-bold ">
                                    {{ !empty($data['totalBooking']) ? $data['totalBooking'] : '0'}}</h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
