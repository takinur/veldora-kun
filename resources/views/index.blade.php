...
<!-- Start Home -->
<header class="relative flex items-center justify-center md:h-screen overflow-hidden">
    <div class="relative z-30 mr-3 text-2xl bg-transparent bg-opacity-50 rounded-xl w-full">

        <div class="float-left" id="BGtitle" data-aos="fade-up" data-aos-once="true" data-aos-easing="ease-in-sine"
        ...
        <div class="float-right mt-7 ml-4" data-aos="zoom-in-up" data-aos-once="true" data-aos-easing="ease-in-sine"
            data-aos-delay="3000" data-aos-duration="800">
    ...
    {{-- <video id="video-bg" autoplay muted class="absolute z-10 w-auto min-w-full min-h-full max-w-none">
        <source src="{{ asset('images/businessmen-walking002.mp4') }}" type="video/mp4" />
        Your browser does not support the video tag.
    </video> --}}
</header>
...
<div class="section gray paddingbot-clear">
    ...
    {{-- <div class="triangle margintop10" data-height="80" data-color-bottom="#ffffff" data-color-top="transparent">
    </div> --}}
</div>
<!-- End Section -->
...
<div class="section paddingtop-clear paddingbot-clear">
    ...
    {{-- <div class="triangle marginbot50" data-height="80" data-color-bottom="transparent" data-color-top="#f0f2f5">
    </div> --}}
    ...
    <div class="container">
        ...
        <div class="w-full pt-8">
            <div class="flex flex-col sm:flex-row justify-center mb-6 sm:mb-0">
                <div
                    class="sm:flex-1 lg:flex-initial lg:w-1/4 rounded-t-lg rounded-tr-none bg-gray-50 mt-4 flex flex-col">
                    ...
                    <div class="w-full text-center text-black font-bold px-8 pt-8 text-xl my-8">
                        $20 /KG
                    </div>

                </div>
                <div
                    class="flex-1 lg:flex-initial lg:w-1/4 rounded-t-lg bg-gray-50 mt-4 sm:-mt-4 shadow-lg z-30 flex flex-col">
                ...
                <div class="flex-1 lg:flex-initial lg:w-1/4 rounded-t-lg rounded-tl-none bg-gray-50 mt-4 flex flex-col">
            ...
            <div class="text-left mb-1 mt-0 w-9/12 md:ml-52">
